 ...
 * Copyright (c) 2009, Alexander Kosenkov
...
public class AlarmDatabase {
	...
	public static class Record {
		...
		public boolean equals(Object o) {
			...
			if (daysOfWeek != record.daysOfWeek) return false;
			if (hour != record.hour) return false;
			if (id != record.id) return false;
			if (minute != record.minute) return false;
			if (vibrate != record.vibrate) return false;
			if (audio != null ? !audio.equals(record.audio) : record.audio != null) return false;
